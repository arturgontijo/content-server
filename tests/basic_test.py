...
def main():
    ...
    uid_0, content_id_0_model = cs.add(uid="0",
                                       service_name="Service_1",
                                       rpc_method="Model")
    uid_0, content_id_0_file_1 = cs.add(uid="0",
                                        service_name="Service_2",
                                        rpc_method="File_1")
    uid_0, content_id_0_file_2 = cs.add(uid="0",
                                        service_name="Service_3",
                                        rpc_method="File_2")
    uid_0, content_id_0_file_3 = cs.add(uid="0",
                                        service_name="Service_4",
                                        rpc_method="File_3")
    uid_0, content_id_0_file_4 = cs.add(uid="0",
                                        service_name="Service_5",
                                        rpc_method="File_4")
    uid_0, content_id_0_file_5 = cs.add(uid="0",
                                        service_name="Service_6",
                                        rpc_method="File_5")
    uid_0, content_id_0_file_6 = cs.add(uid="0",
                                        service_name="Service_7",
                                        rpc_method="File_6")
    ...
    uid_1, content_id_1_file = cs.add(uid="1",
                                      service_name="Service_1",
                                      rpc_method="File")
    cs.update(content_id=content_id_1_file, queue_pos=0)

    uid_2, content_id_2_file = cs.add(uid="2",
                                      service_name="Service_1",
                                      rpc_method="File")

    uid_3, content_id_3_file = cs.add(uid="3",
                                      service_name="Service_1",
                                      rpc_method="File")
    ...
    uid_4, content_id_3_file = cs.add(uid="4",
                                      service_name="Service_1",
                                      rpc_method="File")

    uid_5, content_id_3_file = cs.add(uid="5",
                                      service_name="Service_1",
                                      rpc_method="File")
