...
# source: service/service_spec/example_async_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='service/service_spec/example_async_service.proto',
...
_RESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uid', full_name='example_service.Result.uid', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Numbers = _reflection.GeneratedProtocolMessageType('Numbers', (_message.Message,), dict(
  DESCRIPTOR = _NUMBERS,
  __module__ = 'service.service_spec.example_async_service_pb2'
